/* Parallelize the code using OpenMP for shared memory parallelism (Create a separate plot
that compares the performance of using a different number of threads) */
